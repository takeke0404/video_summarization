...
def main(comment_file):
    print("LOAD", "./comments/"+comment_file+".json")
    comments_json = json.load(open("./comments/"+comment_file+".json", "r", encoding="UTF-8"))
    ...
    data = []
    with open("./segmentation/"+comment_file_name+".csv") as f:
